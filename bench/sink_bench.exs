# Repo and Vault auto-started by the application
...
defmodule Bench.Helper do
  ...
  def build_batch(n), do: for(_ <- 1..n, do: build_event())
end

IO.puts("Cleaning table...")
OCSF.Ecto.Repo.query!("TRUNCATE ocsf_event__logs")

single_event = Bench.Helper.build_event()
batch_10 = Bench.Helper.build_batch(10)
batch_100 = Bench.Helper.build_batch(100)
batch_500 = Bench.Helper.build_batch(500)
